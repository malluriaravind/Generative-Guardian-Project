...
type AppSpendTableCollapseBody = {
  id: string;
  type: StatsType;
};

const AppSpendTableCollapseBody = ({ type, id }: AppSpendTableCollapseBody) => {
  ...
  const [sortModel, setSortModel] = useState([
    { field: "name", sort: "desc" }, // Default sorting for Name column
  ]);
...
export default AppSpendTableCollapseBody;
