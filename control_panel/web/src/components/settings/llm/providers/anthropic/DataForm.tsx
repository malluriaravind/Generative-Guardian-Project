...
const DataForm: React.FC<DataFormProps> = ({ control, current }: DataFormProps) => <>
    <Controller
        ...
        defaultValue={current?.anthropic?.api_key}
    ...
    <TimeoutField
        name='anthropic'
        control={control}
        defaultValue={current?.anthropic?.timeout}
    />
    <NumberField
        name="anthropic.max_connections"
        control={control}
        defaultValue={current?.anthropic?.max_connections || 50}
        label="Maximum number of concurrent connections"
    />
    <NumberField
        name="anthropic.max_keepalive_connections"
        control={control}
        defaultValue={current?.anthropic?.max_keepalive_connections || 10}
